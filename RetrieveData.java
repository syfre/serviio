...
class Serviio {
   ...
   public void printStats() {
      System.out.println(String.format("Total movies:%d, missing:%d, actorCount:%d, genreCount:%d",
            getMovieCount(),
            getMovieMissing(),
            getActorCount(),
            getGenreCount()
   ...
   public void start() throws IOException, InterruptedException, ClassNotFoundException, SQLException {
